...
export default class TextInput extends Container {
    ...
    _updateSurrogate () {
        ...
        // this._surrogate.x = (this._previous.input_bounds.width - this._surrogate.width) / 2;
        console.log('this.this._previous.input_bounds', this._previous.input_bounds.width)
        console.log('this._surrogate', this._surrogate)
